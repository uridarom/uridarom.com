...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "PageLayout", $$PageLayout, { "title": title, "activePage": "photos" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="flex flex-col items-center px-6 pb-24"> <!-- Title --> <h1 class="text-white text-center mt-12 mb-8" style="font-size: clamp(1.6rem, 3vw, 2.2rem);"> ${title} </h1> <!-- Primary Image --> <div style="width: clamp(60%, 70vw, 900px);"> ${renderComponent($$result2, "Image", $$Image, { "src": image, "alt": title, "widths": [800, 1200, 1800], "sizes": "(max-width: 768px) 90vw, 70vw", "class": "w-full block", "loading": "eager" })} </div> <!-- Text Content --> <div class="mt-12 text-white" style="width: clamp(60%, 70vw, 900px);"> ${acquisition && renderTemplate`<section class="mb-10"> <h2 class="font-bold text-white mb-4" style="font-size: 0.78rem; letter-spacing: 0.12em; text-transform: uppercase;">
Acquisition
